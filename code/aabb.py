# Apparently axis-aligned bounding box is the full form of aabb
...
class AABB(object):
    ...
    def render(self):
        """ render the AABB. This will be useful for debugging purposes (i'm gonna cry)"""
